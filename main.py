...
DATABASE_URL = "postgresql://blog_db_r721_user:6SHrCYlZvY9lSPBgKaHQIwlVkbRsYyaa@dpg-ci2sjbu7avj2t35lhki0-a/blog_db_r721"
##CONNECT TO DB
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, is_logged=current_user.is_authenticated, form=form,
